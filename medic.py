...
toolkit = [
    Tool(
        name="google-search",
        description="Search for Google results on reliable medical websites (CDC, MayoClinic, MedlinePlus, WebMD, etc.). Use the chain tool to present results to the user in a detailed manner.",
        func=search.run
    ),
    Tool(
        name="chain",
